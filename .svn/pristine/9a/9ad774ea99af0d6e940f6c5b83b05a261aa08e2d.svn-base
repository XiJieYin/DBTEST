...
public class FileAnalyser {
	...
	static FileAnalyser analyser = null;
	
	public static FileAnalyser getInstance() {
		if (analyser == null)
    ...
    public static void readFileByBytes(String fileName) {  
        ...
        try {  
            ...
            FileAnalyser.showAvailableBytes(in);  
