...
public class HjdjSwzx {
    private String id;

    private String ywlsh;

    private String spslh;
    ...
    private String bdyymc;

    private String bdyy;

    private String tgclmc;
    ...
    private String xjgajg;

    private String xjgajgmc;

    private String ysqrgx;

    private String ysqrgxmc;

    private String sfhjsfz;

    private String sfhjsfzmc;
    ...
    public String getSpslh() {
        return spslh;
    }

    public void setSpslh(String spslh) {
        this.spslh = spslh == null ? null : spslh.trim();
    }
    ...
    public void setPcsmc(String pcsmc) {
        this.pcsmc = pcsmc == null ? null : pcsmc.trim();
    }
    ...
    public void setYwlbmc(String ywlbmc) {
        this.ywlbmc = ywlbmc == null ? null : ywlbmc.trim();
    }
    ...
    public void setBdyymc(String bdyymc) {
        this.bdyymc = bdyymc == null ? null : bdyymc.trim();
    }
    ...
    public String getTgclmc() {
        return tgclmc;
    }

    public void setTgclmc(String tgclmc) {
        this.tgclmc = tgclmc == null ? null : tgclmc.trim();
    }
    ...
    public void setTgcl(String tgcl) {
        this.tgcl = tgcl == null ? null : tgcl.trim();
    }
    ...
    public void setSwdd(String swdd) {
        this.swdd = swdd == null ? null : swdd.trim();
    }
    ...
    public void setSwzmbh(String swzmbh) {
        this.swzmbh = swzmbh == null ? null : swzmbh.trim();
    }

    public String getSwzmqfdw() {
        return swzmqfdw;
    }

    public void setSwzmqfdw(String swzmqfdw) {
        this.swzmqfdw = swzmqfdw == null ? null : swzmqfdw.trim();
    }
    ...
    public void setSqrgmsfhm(String sqrgmsfhm) {
        this.sqrgmsfhm = sqrgmsfhm == null ? null : sqrgmsfhm.trim();
    }
    ...
    public String getXjgajg() {
        return xjgajg;
    }

    public void setXjgajg(String xjgajg) {
        this.xjgajg = xjgajg == null ? null : xjgajg.trim();
    }
    ...
    public void setXjgajgmc(String xjgajgmc) {
        this.xjgajgmc = xjgajgmc == null ? null : xjgajgmc.trim();
    }
    ...
    public String getYsqrgxmc() {
        return ysqrgxmc;
    }

    public void setYsqrgxmc(String ysqrgxmc) {
        this.ysqrgxmc = ysqrgxmc == null ? null : ysqrgxmc.trim();
    }

    public String getSfhjsfz() {
        return sfhjsfz;
    }

    public void setSfhjsfz(String sfhjsfz) {
        this.sfhjsfz = sfhjsfz == null ? null : sfhjsfz.trim();
    }

    public String getSfhjsfzmc() {
        return sfhjsfzmc;
    }

    public void setSfhjsfzmc(String sfhjsfzmc) {
        this.sfhjsfzmc = sfhjsfzmc == null ? null : sfhjsfzmc.trim();
    }
    ...
    public void setXzjdmc(String xzjdmc) {
        this.xzjdmc = xzjdmc == null ? null : xzjdmc.trim();
    }
    ...
    public void setJlxmc(String jlxmc) {
        this.jlxmc = jlxmc == null ? null : jlxmc.trim();
    }

    public String getJcw() {
        return jcw;
    }

    public void setJcw(String jcw) {
        this.jcw = jcw == null ? null : jcw.trim();
    }
    ...
    public void setJcwmc(String jcwmc) {
        this.jcwmc = jcwmc == null ? null : jcwmc.trim();
    }
}