...
public class OriInfoRhyyxxkCopy {
    private Long id;
    ...
    public void setQfrq(String qfrq) {
        this.qfrq = qfrq == null ? null : qfrq.trim();
    }
    ...
    public void setRhlx(String rhlx) {
        this.rhlx = rhlx == null ? null : rhlx.trim();
    }

    public String getZbkhm() {
        return zbkhm;
    }

    public void setZbkhm(String zbkhm) {
        this.zbkhm = zbkhm == null ? null : zbkhm.trim();
    }
