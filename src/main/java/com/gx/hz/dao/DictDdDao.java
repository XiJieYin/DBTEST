 ...
 * 
 */
public interface DictDdDao extends BaseDao<DictDd> {
	
	DictDdDao  selectAjIdByAjh(int DictDd);
	
	DictDdDao checkAjh(String DictDd);
	
	List<Map<String, Object>> countByOrg();
	
	DictDd selectByDDMC(String ddmc);
}
